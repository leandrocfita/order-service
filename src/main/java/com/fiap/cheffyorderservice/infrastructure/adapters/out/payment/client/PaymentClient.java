...
import com.fiap.cheffyorderservice.infrastructure.adapters.out.payment.config.PaymentClientConfig;
...
@FeignClient(name = "payment-client", url = "${payment.api.url}", configuration = PaymentClientConfig.class)
